...
public:
  enum {
    ...
    T__20 = 21, T__21 = 22, T__22 = 23, IDENTIFIER = 24, NUMBER = 25, WS = 26
  };

  enum {
    RuleProgram = 0, RuleStatement = 1, RuleVariableDeclaration = 2, RuleAssignment = 3, 
    RuleIfStatement = 4, RuleFunctionDeclaration = 5, RuleParameterList = 6, 
    RuleFunctionCall = 7, RuleArgumentList = 8, RuleForStatement = 9, RulePrintStatement = 10, 
    RuleBlock = 11, RuleExpression = 12
  };

  MyLanguageParser(antlr4::TokenStream *input);
  ~MyLanguageParser();
